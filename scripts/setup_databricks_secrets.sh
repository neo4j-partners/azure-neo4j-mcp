...
#   2. Run: ./scripts/setup_databricks_secrets.sh [scope-name]
#      Examples:
#        ./scripts/setup_databricks_secrets.sh                    # Uses default: mcp-neo4j-secrets
#        ./scripts/setup_databricks_secrets.sh mcp-neo4j-secrets
#        ./scripts/setup_databricks_secrets.sh my-custom-scope
...
echo "The write-cypher tool is not available through this connection."
echo ""
