...
def print_menu() -> str | None:
    ...
    try:
        choice = input("Enter your choice (0-4, A): ").strip().upper()
        if choice in ("0", "1", "2", "3", "4", "A"):
            return choice
        else:
            print("\nInvalid choice. Please enter 0-4 or A.")
            return None
...
""",
    ...
    parser.add_argument(
        ...
        type=str,
        choices=["1", "2", "3", "4", "a", "A"],
        help="Demo to run: 1-4=Financial Documents, a=All",
    )
